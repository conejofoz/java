...
public class FuncoesDeStrings {
	...
	public static void main(String[] args) {
		...
		System.out.println("Minúscula--:" + x1);
		System.out.println("Maiúscula--:" + x2);
		System.out.println("Trim-------:" + x3);
		System.out.println("Substring--:" + x4);
		System.out.println("Substring--:" + x5);
		System.out.println("replace....:" + x6);
		
		System.out.println("Primeira ocorrência da letra o " + i);
		System.out.println("Última ocorrência da letra o   " + j);
